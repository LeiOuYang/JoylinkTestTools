...
//static mavlink_system_t gcs_mavlink_system = {0xff,0xbe};
/*
...
MAVLINK_HELPER void comm_send_ch(mavlink_channel_t chan, uint8_t ch)  //add by Awesome
{
	switch(chan)
	{
		case MAVLINK_COMM_1:
		{
            insertCharLoopQueue( &sendMavlinkDataQueue, ch );
		...
		case MAVLINK_COMM_2:
		{
            ...
            //insertCharLoopQueue( &usart2_send_queue, (unsigned char)ch );
			break;
		}
		case MAVLINK_COMM_3:
		{
